...
<ul class="nav flex-column">
    ...
    <thead class ="bg-warning" >
     ...
     $sql="SELECT * from reservasi WHERE status = 1" ;
          ...
          <td><?=$row["jam_reservasi"]?></td>
           ...
           <?php 
            ...
            ?>
               ...
               <td>
               <a class="btn btn-lg btn-dark" title="Hapus" href="hapusrsv.php?id_reservasi=<?= $row["id_reservasi"]; ?>" onclick="return confirm('Ingin Menghapus Pemesanan Tempat?')">
