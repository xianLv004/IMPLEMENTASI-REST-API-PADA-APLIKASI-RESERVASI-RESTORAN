...
<main class="col-lg-9">
    ...
    <nav class="navbar navbar-light d-flex justify-content-end">
        <a class="btn btn-warning fw-bold" href="tambah.php">+ Tambah Menu Masakan</a>
    </nav>
  </div>
  <table class="table table-striped">
    ...
    ?>
       <tr class ="bg-light">
          ...
          <td><?=$row["status"]?></td>
          <td>
              <a class="btn btn-lg btn-warning" title="Edit" href="edit.php?id_menu=<?= $row["id_menu"]; ?>">
                            <i class="bi bi-pencil-fill"></i>
                        </a>
                        <a class="btn btn-lg btn-dark" title="Hapus" href="hapus.php?id_menu=<?= $row["id_menu"]; ?>" onclick="return confirm('Ingin Menghapus Menu?')">
